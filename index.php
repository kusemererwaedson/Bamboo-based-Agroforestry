...
<body class="main-layout">
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light sticky" id="navbar_top">
     <a href="index.html"> <img src="images/log.png" alt="" height=""> &nbsp</a>
...
<br> -->
   ...
   <!-- <div style="background-image: url('images/4.jpg'); background-size: cover; height: 430px;" class="m-5 w-75 mx-auto">
      <div style="padding: 180px 0 0 10px;">
         ...
         <button type="button" class="btn btn-warning btn-lg ">Join Today</button>
         <button type="button" class="btn btn-outline-warning btn-lg">Read Faq</button>
   ...
   <!-- projects end-->
   <!-- balance -->
   <div class="balance w-75 mx-auto">
      <div class="container-fluid">
         <div class="row d_flex w-75">
            <div class="col-md-5 padding_left0">
               <div class="yoga_img">
                  <figure><img src="images/4.jpg" style="height: 400px;"></figure>
               </div>
            </div>
            <div class="col-md-6 offset-md-1">
               <div class="titlepage">
                  <h2 class="padd_top30">About TIGPE</h2>
                  <p>We are in the business of agriculture, agro-processing and farmland and timberland investment management in Uganda</p>
                  <a class="read_more ye_b5n " href="invest.html"> Read More</a>
               </div>
            </div>
         </div>
                           ...
                           <div class="container parile0">
                              <div class="carousel-caption relative2">
                                 <div class="row d_flex">
                                    <div class="col-md-12">
                                       <i><img class="qusright" src="images/t.png" alt="#" /><img src="images/tes.png"
                                             alt="#" /><img class="qusleft" src="images/t.png" alt="#" /></i>
                                       <div class="aliq">
                                          <span>Aliqua</span>
              ...
              <div class="row">
                  <div class="col-md-4">
                      ...
                      <ul class="link_menu">
                          ...
                          <li><a href="invest.html"> About Us</a></li>
                  ...
                  <div class="col-lg-3 offset-mdlg-2 col-md-4 offset-md-1">
                      <h3>Contact </h3>
                      <ul class="conta">
                        <li> <i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:admin@tigpe.org"> admin@tigpe.org</a></li>
                        <li><i class="fa fa-mobile" aria-hidden="true"></i> +256 (0) 200907036</li>
                          <li><i class="fa fa-map-marker" aria-hidden="true"></i>Amakmoo Place Plot 640-642, Block 275 Gombe “A”, Wakiso Town</li>  
                      </ul>
